...
if __name__ == "__main__":
    ...
    try:
        ...
        webbrowser.open_new_tab('https://accounts.spotify.com/authorize?client_id=%s&response_type=token&redirect_uri=http://aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.com/&scope=playlist-modify-public playlist-modify-private' % CLIENT_ID)
        sys.exit(1)
